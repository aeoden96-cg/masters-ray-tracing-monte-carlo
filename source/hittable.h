...
class hittable  {
    public:
        ...
        virtual float  pdf_value(const glm::vec3 &o, const vec3 &v) const  {return 0.0;}
        virtual glm::vec3 random(const glm::vec3 &o) const {return {1, 0, 0};}
};
...
class translate : public hittable {
    public:
        translate(hittable *p, const glm::vec3& displacement) : ptr(p), offset(displacement) {}
        virtual bool hit(const ray& r, float t_min, float t_max, hit_record& rec) const;
        virtual bool bounding_box(float t0, float t1, aabb& box) const;
        hittable *ptr;
        glm::vec3 offset;
